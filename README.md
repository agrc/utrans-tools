...
The attribute-rule utilities are in [attribute-rules/deploy_ar.py](attribute-rules/deploy_ar.py) and [attribute-rules/deploy_all_ar.py](attribute-rules/deploy_all_ar.py).
