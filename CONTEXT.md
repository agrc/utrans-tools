...
**Unlinked new record**:
A DFC result with change type `N` and no target UTRANS road. It can be added as a new UTRANS road or assigned a non-completed disposition.
