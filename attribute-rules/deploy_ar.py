...
def _delete_attribute_rule(args: argparse.Namespace, rule_name: str) -> None:
	arcpy.management.DeleteAttributeRule(args.in_table, rule_name, args.type)
...
def _run_deploy_mode(
	...
	if immutable_diffs:
		...
		_delete_attribute_rule(args, rule_name)
		_add_attribute_rule(args, script_text, rule_name)
