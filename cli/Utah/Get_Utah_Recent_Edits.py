"""Utah County recent edits detection for ArcGIS Pro (Python 3).
...
DEFAULT_COMPARE_FIELDS = (
    "ROADPREDIR ROADPREDIR; ROADNAME ROADNAME; ROADTYPE ROADTYPE; "
    "ROADPOSTDIR ROADPOSTDIR; ALTROADNAME ALTROADNAME; ALTROADTYPE ALTROADTYPE; "
    "ALTROADNAME2 ALTROADNAME2; ALTROADTYPE2 ALTROADTYPE2; "
...
def run_change_detection(
    ...
    log("Beginning detect feature change process for UtahCo at: " + time.strftime("%c"))
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Detect recent edits between Utah update and baseline roads.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=(
            "Examples:\n"
            "  python Get_Utah_Recent_Edits.py --help\n"
            "\n"
            "  python Get_Utah_Recent_Edits.py "
            "--update-features \"<parent>\\utrans-tools\\data\\Utah\\UtahCo_20260624.gdb\\RoadCenterline\" "
            "--base-features \"<parent>\\utrans-tools\\data\\Utah\\UtahCo_20260521.gdb\\RoadCenterline\"\n"
            "\n"
            "  python Get_Utah_Recent_Edits.py "
...
# utrans-tools\cli\Utah: python Get_Utah_Recent_Edits.py --update-features "Z:\Documents\gdb\UtahCo_20260624.gdb\RoadCenterline" --base-features "Z:\Documents\gdb\UtahCo_20260521.gdb\RoadCenterline" --dfc-output-name DFC_UtahToUtah_07_15_26 --stats-table-name new_roads_stats_utah_07_15_26 --recents-name RoadCenterline_Recents_07_15_26