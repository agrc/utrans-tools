# Name:        (Wasatch's script to compare their data with what they sent us last time)
...
#env.workspace = r"D:\UTRANS\Updates\WasatchCenterlines_16_02_17.gdb" ### change database name ###

#strTimeNow = time.strftime("%c")

# Set local variables
updateFeatures = r"L:\agrc\data\county_obtained\Wasatch\WasatchCounty20260521.gdb\WC_ROAD" ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"L:\agrc\data\county_obtained\Wasatch\WasatchCounty20260118.gdb\WC_ROAD" ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_WasatchToWasatch"
...
statsTable = dirname + "\\stats_wasatch_to_wasatch"
...
compare_fields = "FROMADDR_L FROMADDR_L; TOADDR_L TOADDR_L; FROMADDR_R FROMADDR_R; TOADDR_R TOADDR_R; FULLNAME FULLNAME; PREDIR PREDIR; AN_NAME AN_NAME"


arcpy.AddMessage("Begining detect feature change process for Wasatch at: " + time.strftime("%c"))
...
expression = r"DFC_WasatchToWasatch.CHANGE_TYPE <> 'NC'"
layerName = "roads_lyr"
