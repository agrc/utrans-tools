...
#env.workspace = r"D:\UTRANS\Updates\IronCenterlines_16_02_17.gdb" ### change database name ###

#strTimeNow = time.strftime("%c")

# Set local variables
updateFeatures = r"L:\agrc\data\county_obtained\Iron\Iron_20260331.gdb\Iron_Roads" ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"L:\agrc\data\county_obtained\Iron\Iron_20251230.gdb\Iron_Rds" ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_IronToIron"
...
statsTable = dirname + "\\stats_iron_to_iron"
...
## compare values
compare_fields = "PREDIR PREDIR; STREETNAME STREETNAME; STREETTYPE STREETTYPE; SUFDIR SUFDIR; ALIAS1 ALIAS1; ALIAS1TYPE ALIAS1TYPE; ALIAS2 ALIAS2; ALIAS2TYPE ALIAS2TYPE; ACSALIAS ACSALIAS; ACSNAME ACSNAME; ACSSUF ACSSUF; L_F_ADD L_F_ADD; L_T_ADD L_T_ADD; R_F_ADD R_F_ADD; R_T_ADD R_T_ADD"

arcpy.AddMessage("Begining detect feature change process for Iron at: " + time.strftime("%c"))
...
expression = r"DFC_IronToIron.CHANGE_TYPE <> 'NC'"
layerName = "roads_lyr"
print ("Begin selection process...")
arcpy.SelectLayerByAttribute_management(layerName, "NEW_SELECTION", expression)

# Copy the layer to a new permanent feature class
outFeature = dirname + "\\RoadCenterline_Recents"
print ("Write features out to feature class...")
