"""Cache County recent edits detection for ArcGIS Pro (Python 3).
...
def run_change_detection(
    ...
    log("Beginning detect feature change process for Cache at: " + time.strftime("%c"))
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Detect recent edits between Cache update and baseline roads.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=(
            "Examples:\n"
            "  python Get_Cache_Recent_Edits.py --help\n"
            "\n"
            "  python Get_Cache_Recent_Edits.py "
            "--update-features \"Z:\\Documents\\gdb\\CACHE\\CacheCo_20260514.gdb\\CacheCountyRoads\" "
            "--base-features \"Z:\\Documents\\gdb\\CACHE\\CacheCo_20260210.gdb\\Roads\"\n"
            "\n"
            "  python Get_Cache_Recent_Edits.py "
...
# utrans-tools\cli\Cache: python Get_Cache_Recent_Edits.py --update-features "Z:\Documents\gdb\CACHE\CacheCo_20260514.gdb\CacheCountyRoads" --base-features "Z:\Documents\gdb\CACHE\CacheCo_20260210.gdb\CacheCountyRoads" --dfc-output-name DFC_CacheToCache_07_16_26 --stats-table-name stats_cache_to_cache_07_16_26 --recents-name RoadCenterline_Recents_07_16_26
