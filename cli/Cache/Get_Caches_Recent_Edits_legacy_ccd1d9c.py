...
# Set local variables
updateFeatures = r"Z:\Documents\gdb\CACHE\CacheCo_20260514.gdb\CacheCountyRoads"  ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"Z:\Documents\gdb\CACHE\CacheCo_20260210.gdb\CacheCountyRoads"  ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_CacheToCache_legacy"
...
statsTable = dirname + "\\stats_cache_to_cache_legacy"
