# Name:        (Wayne's script to compare their data with what they sent us last time)
...
# Set local variables
updateFeatures = r"L:\agrc\data\county_obtained\Wayne\WayneCo_20260414.gdb\WayneCoRds_20260409" ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"L:\agrc\data\county_obtained\Wayne\WayneCo_20251020.gdb\WayneCoRds" ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_WayneToWayne"
...
statsTable = dirname + "\\stats_Wayne_to_Wayne"
...
expression = r"DFC_WayneToWayne.CHANGE_TYPE <> 'NC'"
layerName = "roads_lyr"
