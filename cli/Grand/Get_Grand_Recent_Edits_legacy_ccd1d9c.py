...
# Set local variables
updateFeatures = r"Z:\Documents\gdb\GRAND\GrandCo_20260514.gdb\GC__RDS_05_01_26"  ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"Z:\Documents\gdb\GRAND\GrandCo_20240812.gdb\GRANDROADS_24"  ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_GrandtoGrand_legacy"
...
statsTable = dirname + "\\stats_grand_to_grand_legacy"
