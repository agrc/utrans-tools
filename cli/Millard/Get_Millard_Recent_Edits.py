# Name:        (millard's script to compare their data with what they sent us last time)
...
# Set local variables
updateFeatures = r"L:\agrc\data\county_obtained\Millard\Millard_20251217.gdb\Millard_Roads_Dec_2025" ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"L:\agrc\data\county_obtained\Millard\Millard_20241216.gdb\Millard_Roads_Dec2024" ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_MillardToMillard"
...
statsTable = dirname + "\\stats_millard_to_millard"
...
## compare values
#compare_fields = "PREDIR PREDIR; FULLNAME FULLNAME; STREETTYPE STREETTYPE; SUFDIR SUFDIR; L_F_ADD L_F_ADD; L_T_ADD L_T_ADD; R_F_ADD R_F_ADD; R_T_ADD R_T_ADD"
compare_fields = "FULLNAME FULLNAME; L_F_ADD L_F_ADD; L_T_ADD L_T_ADD; R_F_ADD R_F_ADD; R_T_ADD R_T_ADD" # use this one when desperate
#compare_fields = "PREDIR PREDIR; FULLNAME FULLNAME; STREETTYPE STREETTYPE; SUFDIR SUFDIR; ALIAS1 ALIAS1; ALIAS1TYPE ALIAS1TYPE; ALIAS2 ALIAS2; ALIAS2TYPE ALIAS2TYPE; L_F_ADD L_F_ADD; L_T_ADD L_T_ADD; R_F_ADD R_F_ADD; R_T_ADD R_T_ADD"

arcpy.AddMessage("Begining detect feature change process for millard at: " + time.strftime("%c"))
...
expression = r"DFC_MillardToMillard.CHANGE_TYPE <> 'NC'"
layerName = "roads_lyr"
