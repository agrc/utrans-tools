"""Box Elder County recent edits detection for ArcGIS Pro (Python 3).
...
def run_change_detection(
    ...
    log("Beginning detect feature change process for BoxElder at: " + time.strftime("%c"))
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Detect recent edits between BoxElder update and baseline roads.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=(
            "Examples:\n"
            "  python Get_BoxElder_Recent_Edits.py --help\n"
            "\n"
            "  python Get_BoxElder_Recent_Edits.py "
            "--update-features \"Z:\\Documents\\gdb\\BOXELDER\\BoxElder_20260624.gdb\\BECO_RDS\" "
            "--base-features \"Z:\\Documents\\gdb\\BOXELDER\\BoxElder_20260331.gdb\\BE_Roads\"\n"
            "\n"
            "  python Get_BoxElder_Recent_Edits.py "
    ...
    parser.add_argument(
        "--dfc-output-name",
        default="DFC_BoxElderToBoxElder",
        help="Output feature class name for Detect Feature Changes result.",
    )
    parser.add_argument(
        "--stats-table-name",
        default="stats_boxelder_to_boxelder",
...
# utrans-tools\cli\BoxElder: python Get_BoxElder_Recent_Edits.py --update-features "Z:\Documents\gdb\BOXELDER\BoxElder_20260624.gdb\BECO_RDS" --base-features "Z:\Documents\gdb\BOXELDER\BoxElder_20260331.gdb\BE_Roads" --dfc-output-name DFC_BoxElderToBoxElder_07_16_26 --stats-table-name stats_boxelder_to_boxelder_07_16_26 --recents-name RoadCenterline_Recents_07_16_26
