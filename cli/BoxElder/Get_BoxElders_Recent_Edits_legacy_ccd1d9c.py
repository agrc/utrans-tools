# Name:        (BoxElder's script to compare their data with what they sent us last time)
...
# Set local variables
updateFeatures = r"Z:\Documents\gdb\BOXELDER\BoxElder_20260624.gdb\BECO_RDS"  ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"Z:\Documents\gdb\BOXELDER\BoxElder_20260331.gdb\BE_Roads"  ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_BoxElderToBoxElder_legacy"
...
statsTable = dirname + "\\stats_boxelder_to_boxelder_legacy"
