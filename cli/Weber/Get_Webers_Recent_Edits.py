...
# Set local variables
updateFeatures = r"L:\agrc\data\county_obtained\Weber\WeberCounty_20260427.gdb\centerline" ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"L:\agrc\data\county_obtained\Weber\WeberCounty_20260330.gdb\Roads" ### THIS IS THE DATA THEY SENT US LAST TIME
