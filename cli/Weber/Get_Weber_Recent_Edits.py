"""Weber County recent edits detection for ArcGIS Pro (Python 3).
...
DEFAULT_COMPARE_FIELDS = (
    "PREDIR PREDIR; S_NAME S_NAME; STREETTYPE STREETTYPE; SUFDIR SUFDIR; "
    "ALIAS ALIAS; ACS_ALIAS ACS_ALIAS; SUFFIX_911 SUFFIX_911; "
...
def run_change_detection(
    ...
    log("Beginning detect feature change process for Weber at: " + time.strftime("%c"))
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Detect recent edits between Weber update and baseline roads.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=(
            "Examples:\n"
            "  python Get_Weber_Recent_Edits.py --help\n"
            "\n"
            "  python Get_Weber_Recent_Edits.py "
            "--update-features \"<parent>\\utrans-tools\\data\\Weber\\WeberCounty_20260427.gdb\\centerline\" "
            "--base-features \"<parent>\\utrans-tools\\data\\Weber\\WeberCounty_20260330.gdb\\Roads\"\n"
            "\n"
            "  python Get_Weber_Recent_Edits.py "
...
# utrans-tools\cli\Weber: python Get_Weber_Recent_Edits.py --update-features "Z:\Documents\gdb\WeberCounty_20260427.gdb\centerline" --base-features "Z:\Documents\gdb\WeberCounty_20260330.gdb\Roads" --dfc-output-name DFC_WeberToWeber_07_15_26 --stats-table-name stats_weber_to_weber_07_15_26 --recents-name RoadCenterline_Recents_07_15_26
