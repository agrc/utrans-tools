# Name:        (SanJuan's script to compare their data with what they sent us last time)
...
#env.workspace = r"D:\UTRANS\Updates\SanJuanCenterlines_16_02_17.gdb" ### change database name ###
...
# Set local variables
updateFeatures = r"L:\agrc\data\county_obtained\SanJuan\SanJuan_20250728\2025SanJuanRoads.shp" ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"L:\agrc\data\county_obtained\SanJuan\SanJuanRoads_20230717.gdb\SanJuanCountyBRoads2023" ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_SanJuanToSanJuan"
...
statsTable = dirname + "\\stats_SanJuan_to_SanJuan"
...
## compare values
compare_fields = "S_NAME S_NAME;"

arcpy.AddMessage("Begining detect feature change process for SanJuan at: " + time.strftime("%c"))
...
# expression = r"DFC_SanJuanToSanJuan.CHANGE_TYPE <> 'NC'"    # for a feature class
expression = r"DFC_SanJuanToSanJuan.CHANGE_TYP <> 'NC'"   # for a shapefile
layerName = "roads_lyr"
