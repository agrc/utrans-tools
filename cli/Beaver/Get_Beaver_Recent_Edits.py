"""Beaver County recent edits detection for ArcGIS Pro (Python 3).
...
def run_change_detection(
    ...
    log("Beginning detect feature change process for Beaver at: " + time.strftime("%c"))
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Detect recent edits between Beaver update and baseline roads.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=(
            "Examples:\n"
            "  python Get_Beaver_Recent_Edits.py --help\n"
            "\n"
            "  python Get_Beaver_Recent_Edits.py "
            "--update-features \"<parent>\\utrans-tools\\data\\Beaver\\BeaverCo_20260604.gdb\\<roads_fc>\" "
            "--base-features \"<parent>\\utrans-tools\\data\\Beaver\\BeaverCo_20250617.gdb\\<roads_fc>\"\n"
            "\n"
            "  python Get_Beaver_Recent_Edits.py "
...
# utrans-tools\cli\Beaver: python Get_Beaver_Recent_Edits.py --update-features "Z:\Documents\gdb\BEAVER\BeaverCo_20260604.gdb\Beaver_Roads2025" --base-features "Z:\Documents\gdb\BEAVER\BeaverCo_20250617.gdb\Beaver_Roads2025" --dfc-output-name DFC_BeaverToBeaver_07_16_26 --stats-table-name stats_beaver_to_beaver_07_16_26 --recents-name RoadCenterline_Recents_07_16_26