...
# Set local variables
updateFeatures = r"L:\agrc\data\county_obtained\Beaver\BeaverCo_20250617.gdb\Beaver_Roads2025" ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"L:\agrc\data\county_obtained\Beaver\BeaverCo_20240612.gdb\BeavRds" ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_BeaverToBeaver"
...
expression = r"DFC_BeaverToBeaver.CHANGE_TYPE <> 'NC'"
layerName = "roads_lyr"
