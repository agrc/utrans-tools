...
# Set local variables
updateFeatures = r"Z:\Documents\gdb\EMERY\EmeryCo_20260611.gdb\Roads"  ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"Z:\Documents\gdb\EMERY\EmeryCo_20250717.gdb\RoadExport"  ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_EmeryToEmery_legacy"
...
statsTable = dirname + "\\stats_emery_to_emery_legacy"
