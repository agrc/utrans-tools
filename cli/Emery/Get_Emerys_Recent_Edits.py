# Name:        (Emery's script to compare their data with what they sent us last time)
...
#env.workspace = r"D:\UTRANS\Updates\EmeryCenterlines_16_02_17.gdb" ### change database name ###

#strTimeNow = time.strftime("%c")

# Set local variables
updateFeatures = r"L:\agrc\data\county_obtained\Emery\EmeryCo_20260611.gdb\Roads" ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"L:\agrc\data\county_obtained\Emery\EmeryCo_20250717.gdb\RoadExport" ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_EmeryToEmery"
...
## compare values
compare_fields = "PRE_DIR PRE_DIR; S_NAME S_NAME; S_TYPE S_TYPE; L_F_ADD L_F_ADD; L_T_ADD L_T_ADD; R_F_ADD R_F_ADD; R_T_ADD R_T_ADD; ALIAS1 ALIAS1; ALIAS1_TYP ALIAS1_TYP; ALIAS2 ALIAS2; ALIAS2_TYP ALIAS2_TYP; SUF_DIR SUF_DIR"

arcpy.AddMessage("Begining detect feature change process for Emery at: " + time.strftime("%c"))
...
expression = r"DFC_EmeryToEmery.CHANGE_TYPE <> 'NC'"
layerName = "roads_lyr"
