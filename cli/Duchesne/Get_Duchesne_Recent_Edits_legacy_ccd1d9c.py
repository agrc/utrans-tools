# Name:        (Duchesne's script to compare their data with what they sent us last time)
...
# Set local variables
updateFeatures = r"Z:\Documents\gdb\DUCHESNE\DuchesneCo_20191009.gdb\Centerlines"  ### THIS WOULD BE THE NEWEST DATA
baseFeatures = r"Z:\Documents\gdb\DUCHESNE\DuchesneCo_20190405.gdb\Centerlines"  ### THIS IS THE DATA THEY SENT US LAST TIME
...
dfcOutput = dirname + "\\DFC_DuchesneToDuchesne_legacy"
...
statsTable = dirname + "\\stats_duchesne_to_duchesne_legacy"
